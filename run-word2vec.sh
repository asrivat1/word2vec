# Usage
# ./run-word2vec.sh <corpus_file> <output_file>
...
time ./word2vec -train "$1-norm0-phrase1" -output $2 -cbow 1 -size 200 -window 10 -negative 25 -hs 0 -sample 1e-5 -threads 20 -binary 0 -iter 15
